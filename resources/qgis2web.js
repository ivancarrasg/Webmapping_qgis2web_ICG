...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:25830',
            extent: [-1099673.713794, 2986435.242554, 1295248.945783, 4998012.359901],
            units: 'm'})
    })
});
...
map.getView().fit([321253.062965, 4064020.869276, 326029.093154, 4067247.916701], map.getSize());
